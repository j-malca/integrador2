 ...
 String url="jdbc:mysql://127.0.0.1:3306/dbscovid?serverTimezone=America/Lima";
    ...
    String password="";
        ...
        con=DriverManager.getConnection(url, user, password);
                 ...
                 rs=st.executeQuery("select id_trabajador from vacunacion;");
                     while(rs.next()){
                    numero +=  "{name: '"+rs.getString(1)+"',y: "+rs.getString(1)+",drilldown: null },";
                     }
     ...
     st =con.createStatement();
                     rs=st.executeQuery("select id_trabajador from vacunacion;");
                     while(rs.next()){
                    Grafico +=  "{name: '"+rs.getString(1)+"',y: "+rs.getString(1)+"},";
                     }
  //out.print(Grafico); 
        ...
        <div class="container">
            <h1>Estado Vacunacion</h1><!-- comment -->
            <hr><!-- comment -->
                <br>
            <div class="row">
                <div class="col-md-6">
