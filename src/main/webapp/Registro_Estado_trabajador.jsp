            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                       <label for="validationDefaultUsername">ESTADO DEL TRABAJAOR</label>
                    </div>
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary btn-md " name="enviar2" data-toggle="button"type="submit">Registrar <i class="fa fa-floppy-o" aria-hidden="true"></i> </button> 
