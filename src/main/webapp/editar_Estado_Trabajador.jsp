...
String descrip = request.getParameter("des_estado");
    %>
                    ...
                    <div class="form-group d-flex">
                        <div class="col-sm-6 d-flex" >
                             <input type="hidden"  class="form-control" id="input_id" name="input_id" value="<%=id3%>" required >
                               <input type="text" class="form-control" id="txtpregunta" name="TXTCATE" value="<%=descrip%>" required>
        ...
        <%
            if (request.getParameter("actualizar") != null) {
               ...
               try {
                    ...
                    con = DriverManager.getConnection("jdbc:mysql://localhost/dbscovid?user=root&password=");
                    st=con.createStatement();
                    st.executeUpdate("update estado_trabajador set desc_estado_trabajador='"+TXTCATE+"' where id_estado_trabajador='"+input_id2+"'");
                    request.getRequestDispatcher("Estado_Trabajador.jsp").forward(request, response);
                } catch (Exception e) {
                    out.print(e);
                }
