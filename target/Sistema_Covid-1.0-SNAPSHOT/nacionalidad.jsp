        ...
        try { 
           ...
           st = con.createStatement();
                                    ...
                                    while (rs.next()){
                                      ...
                                      <td><a href="nacionalidad_editar.jsp?id=<%= rs.getString(1)%>&descripcion=<%= rs.getString(3)%>"><i class="fa fa-pencil" aria-hidden="true"></i></td>
        ...
        <%
            if (request.getParameter("enviar") != null) {
               ...
               try {
                    ...
                    con = DriverManager.getConnection("jdbc:mysql://localhost/dbscovid?user=root&password=");
                    st=con.createStatement();
                    st.executeUpdate("insert into PAIS (desc_pais ) values ('"+TXTCATE+"');");
                    request.getRequestDispatcher("Registro_nacionalidad.jsp").forward(request, response);
                } catch (Exception e) {
                    out.print(e);
                }
