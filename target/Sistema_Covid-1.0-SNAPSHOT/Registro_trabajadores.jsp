<%-- 
    Document   : Registro_trabajadores
    Created on : 9 jul. 2022, 17:14:57
    Author     : Jonnathan
--%>
...
<form action="" method="POST">
  ...
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" id="input_apellido_Paterno" name="input_apellido_Paterno" value="" placeholder="A....r" required>
    </div>
    <div class="col-md-4 mb-3">
...
<!-- fila 3  -->
  ...
  <div  class="form grpup">
  	<div class="">
 	<button class="btn btn-primary btn-md " name="enviar3" data-toggle="button"type="submit">Registrar</button> 
...
<div class="col-sm-6">
  ...
  <tbody>
           ...
           st = con.createStatement();
                                    ...
                                    while (rs.next()){
                                      ...
                                      <tr>
                                        ...
                                        <td> <a href="eliminar_trabajadores.jsp?id=<%= rs.getString(1)%>"><i class="fa fa-trash-o" aria-hidden="true"></i></td>
                                      </tr>  
        ...
        <%
            if (request.getParameter("enviar3") != null) {
